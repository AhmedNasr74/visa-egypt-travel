...
class NewTailorTourNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Name: ' . $this->data['nickname'] . '. '. $this->data['name'])
            ->line('Email: ' . $this->data['email'])
            ->line('Phone: (' . $this->data['country_phone_code'] . ') '. $this->data['phone'])
            ...
            ->line('Arrival Date: ' . $this->data['arrival_date'])
            ->line('Departure Date: ' . $this->data['departure_date'])
