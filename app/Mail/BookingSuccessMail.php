...
class BookingSuccessMail extends Mailable
{
    ...
    public function __construct(Booking $booking)
    {
        ...
        \Log::info('BookingSuccessMail instance created', [
    ...
    private function getSettings()
    {
        try {
            ...
            \Log::info('Site settings retrieved for booking success email', [
            ...
            \Log::error('Failed to retrieve site settings for booking success email', [
