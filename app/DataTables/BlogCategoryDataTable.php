...
->editColumn('featured_image', function (BlogCategory $blogCategory) {
    return '<img class="data-table-img-box" src="' . ($blogCategory->featured_image ?? asset('assets/admin/images/placeholders/50x50.png')) . '" >';
})
