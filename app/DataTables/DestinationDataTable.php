...
class DestinationDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->editColumn('created_at', fn(Destination $destination) => optional($destination->created_at)->format('M Y, d'))
            ...
            ->editColumn('country', fn(Destination $destination) => $destination->country?'Y':'N')
