...
@section('content')
    <form action="{{ route('dashboard.sliders.update' , $slider) }}" method="POST" class="page-body">
        @csrf
        @method('PUT')

        <!-- Container-fluid starts-->
        <x-dashboard.partials.breadcrumb title="Edit Slider" :hideFirst="true">
                    ...
                    <div class="card-body needs-validation add-product-form">
                        ...
                        <x-dashboard.form.multi-tab-card
                            ...
                            <div class="tab-pane fade active show"
                                ...
                                <x-dashboard.form.input-text error-key="title" name="title" id="title" :value="$slider->title"
                                                             label-title="Title"/>
                                <x-dashboard.form.input-checkbox error-key="active" name="active" id="active" :value="$slider->active"
                                                                 label-title="Active"/>
                            </div>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <div class="input-group mb-3">
                                                            <input :value="slide.image" :id="'slides-' + index+ '-image-input'" :name="'slides[' + index+ '][image]'"  type="text" class="form-control" placeholder="Slide Image" aria-label="Select slide image" aria-describedby="button-addon1">
                                                ...
                                                <div class="row" v-for="(locale, k) in locales">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input :value="slide.title[k]" :id="'slides-' + index+ '-image-input'" :name="'slides[' + index+ '][title]['+k+']'"  type="text" class="form-control" placeholder="Slide Title" aria-label="Slide Title">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input :value="slide.description[k]" :id="'slides-' + index+ '-image-input'" :name="'slides[' + index+ '][description]['+k+']'"  type="text" class="form-control" placeholder="Slide Description" aria-label="Slide Title">
                                                        </div>
                                                    </div>
...
@push('js')
    ...
    <script>
        ...
        window.slides = @json($slider->slides->toArray());
