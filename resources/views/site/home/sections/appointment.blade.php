...
<section class="my-20 trip">
    <div class="text-center" data-aos="fade-up">
        <div class="pb-[10px]">
          ...
          <h2 class="text-3xl sm:text-5xl font-semibold capitalize">{{ __('Plan Your Trip') }}</h2>
        </div>
    </div>
    <div class="container">
        <div class="grid gap-6 grid-cols-1 md:grid-cols-[25%_minmax(0,1fr)]">
            <figure class="overflow-hidden relative" data-aos="fade-left">
             ...
             <!--        <p class="text-5xl font-dancingFont text-second-color">30%</p>
                    <span class="capitalize text-2xl font-semibold">{{ __('site.discount') }}</span> -->
                </div>
            </figure>
                ...
                <!-- row 1 -->
                    ...
                    <div class="col-span-6">
                        ...
                        <select  name="hotel_choice"  class="w-full mt-1 p-2 capitalize focus:ring-0 rounded-md">
                            ...
                            <option value="Standard5">{{ __('site.standard_5') }}</option>
                            <option value="Economy">{{ __('site.economy_4') }}</option>
                    ...
                    <div class="col-span-6 md:col-span-12">
                        ...
                        <div class="mt-1 flex justify-between items-center flex-wrap">
                            ...
                            <div>
                                <input type="radio" name="optionsHear" class="optionsHear" id="socialMedia" value="{{ __('site.social_media') }}">
                            ...
                            <div>
                                <input type="radio" name="optionsHear" class="optionsHear" id="aFriend" value="{{ __('site.friend_recommendation') }}">
                                <label for="aFriend" class="capitalize">{{ __('site.friend_recommendation') }}</label>
                            </div>
                        </div>
                    </div>

                    <!-- row 7 -->
                    <button type="submit" class="col-span-6 md:col-span-12 mainBtn " id="appointment-btn">{{ __('site.submit_request') }}</button>
...
<div class="ms-3">
  <h3 class="font-semibold text-base text-gray-700 mb-2">
    ...
    {{ __('site.do_you_face_an_issue_sending_request') }}
  </h3>
