<section class="my-20">
  <div class="container">
      ...
      <div class="text-center" data-aos="fade-up">
          <span class="text-2xl font-dancingFont text-second-color capitalize ">Featured tours</span>
          <h2 class="text-3xl sm:text-5xl font-semibold capitalize">Most Popular Tours</h2>
      </div>

      <div class="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-11">
          @forelse ($packages as $i=>$tour)
