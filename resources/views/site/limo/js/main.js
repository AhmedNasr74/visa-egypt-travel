...
$(document).ready(function(){
    ...
    if ($.fn.owlCarousel && $('.reviewSlider').length) {
    ...
    if ($.fn.owlCarousel && $('.partnerSlider').length) {
    ...
    if ($.fn.owlCarousel && $('.newsSlider').length) {
    ...
    if ($.fn.owlCarousel && $('.teamSlider').length) {
...
$('.videoOverlay').on('click' , function(){
 ...
 $(function(){
    if ($.fn.countTo && $('.counterIt').length) {
 ...
 $(function(){
    if (typeof mixitup !== 'undefined' && document.querySelector('.tourFilter')) {
      mixitup('.tourFilter');
    }
 }
)
